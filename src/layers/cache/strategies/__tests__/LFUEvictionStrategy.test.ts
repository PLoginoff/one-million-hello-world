/**
 * LFUEvictionStrategy Unit Tests
 * 
 * Tests for LFUEvictionStrategy using AAA pattern.
 */

import { LFUEvictionStrategy } from '../eviction/LFUEvictionStrategy';
import { CacheEntry } from '../../domain/entities/CacheEntry';

describe('LFUEvictionStrategy', () => {
  let strategy: LFUEvictionStrategy<string>;

  beforeEach(() => {
    strategy = new LFUEvictionStrategy<string>();
  });
  ...
  describe('selectEntryToEvict', () => {
    ...
    it('should handle tie-breaker by recency', () => {
      const entry1 = new CacheEntry('key1', 'value1', 60000);
      const entry2 = new CacheEntry('key2', 'value2', 60000);
      const entries = new Map<string, CacheEntry<string>>();
  ...
  describe('edge cases', () => {
    ...
    it('should handle equal access counts', () => {
      const entry1 = new CacheEntry('key1', 'value1', 60000);
      const entry2 = new CacheEntry('key2', 'value2', 60000);
      const entries = new Map<string, CacheEntry<string>>();
