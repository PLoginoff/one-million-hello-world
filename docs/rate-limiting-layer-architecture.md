# ADR: Rate Limiting Layer Architecture
...
For detailed information about specific aspects of the Rate Limiting Layer, see:

- [Architecture Overview](../src/layers/rate-limiting/docs/architecture.md) - Components, isolation strategy, consequences
- [Rate Limiting Strategies](../src/layers/rate-limiting/docs/rate-limiting-strategies.md) - Token bucket, sliding window, fixed window, leaky bucket
- [Identifiers and Scopes](../src/layers/rate-limiting/docs/identifiers-scopes.md) - IP, user ID, API key, custom identifiers
- [Rules, Exceptions, and Tiers](../src/layers/rate-limiting/docs/rules-exceptions-tiers.md) - Rule-based limiting, exceptions, tiered limits
- [Statistics and Monitoring](../src/layers/rate-limiting/docs/statistics-monitoring.md) - Statistics tracking, health monitoring, diagnostics
- [Testing Strategy](../src/layers/rate-limiting/docs/testing.md) - Unit/integration tests, performance tests, coverage targets
