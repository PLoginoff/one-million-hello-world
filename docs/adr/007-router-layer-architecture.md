...
## Context
The Router Layer (Layer 7) is responsible for route matching, parameter extraction, and wildcard support. It receives requests from the Middleware Layer and matches them to registered routes before passing to the Controller Layer.
