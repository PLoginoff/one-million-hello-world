# ADR: Middleware Layer Architecture
...
For detailed information about specific aspects of the Middleware Layer, see:

- [Architecture Overview](../src/layers/middleware/docs/architecture.md) - Components, isolation strategy, consequences
- [Logging and Metrics](../src/layers/middleware/docs/logging-metrics.md) - Advanced logging, metrics collection, aggregation
- [Tracing and Correlation](../src/layers/middleware/docs/tracing-correlation.md) - Distributed tracing, span management, correlation IDs
- [Pipeline Management](../src/layers/middleware/docs/pipeline-management.md) - Pipeline architecture, built-in stages, custom stages
- [Health Checks and Diagnostics](../src/layers/middleware/docs/health-diagnostics.md) - Health monitoring, diagnostics, statistics
- [Testing Strategy](../src/layers/middleware/docs/testing.md) - Unit/integration tests, performance tests, coverage targets
