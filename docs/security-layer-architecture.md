# ADR: Security Layer Architecture
...
For detailed information about specific aspects of the Security Layer, see:

- [Architecture Overview](../src/layers/security/docs/architecture.md) - Components, isolation strategy, consequences
- [Authentication and Authorization](../src/layers/security/docs/authentication-authorization.md) - Authentication methods, RBAC, security context
- [CORS and Threat Detection](../src/layers/security/docs/cors-threat-detection.md) - CORS validation, threat patterns, detection algorithms
- [Security Policies](../src/layers/security/docs/security-policies.md) - Policy configuration, rate limiting, IP filtering
- [Testing Strategy](../src/layers/security/docs/testing.md) - Unit/integration tests, security tests, coverage targets
